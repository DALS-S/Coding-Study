-- 제품 테이블 생성
CREATE TABLE item (
    item_num INT PRIMARY KEY,            -- 제품 번호
...
-- 장바구니 테이블 생성
CREATE TABLE cart (
    cart_num      INT PRIMARY KEY,                    -- 장바구니 번호
    id            VARCHAR2(20),                       -- 장바구니 이용 고객 아이디
    item_num      INT,                                -- 제품 번호
    cart_quantity INT,                                -- 장바구니에 담은 제품 수량
...
-- 주문 테이블 생성
CREATE TABLE orders (
    orders_num  INT PRIMARY KEY,                         -- 주문번호
...
CREATE TABLE orders_detail (
    orders_reaction_num INT PRIMARY KEY,             -- 주문처리 번호
    orders_num          INT,                         -- 주문번호/foreign key for order(order_num)
    item_num            INT,                         -- 제품번호/foreign key for item(item_num)
    quantity            INT,                         -- 제품 수량
